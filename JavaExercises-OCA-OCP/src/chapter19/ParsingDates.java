...
public class ParsingDates {
	...
	public static void main(String[] args) {
		...
		LocalDateTime localDateTime2 = LocalDateTime.parse("2014-01-01T09:00:30", parser);
		...
		DateTimeFormatter customFormatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:m");
